...
<body>
 ...
 Exam</a></li>
    ...
    <div class="question">
       <br> 
        Citez deux types de base pour le multiplexage :
    </div>
   ...
   <div>
    ...
    <input id="myField0" type="text"><br><br>
        ...
        <div>
           <input id="btn6" type="submit" value="OK" onclick="C2();M1();">

           <button id="btn40" type="button" ><a href="res3.php"> suivant </a></button>
