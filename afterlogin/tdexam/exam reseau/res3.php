...
<body>
 ...
 Exam</a></li>
    ...
    <div class="question">
         <br> 
        Quelles sont les Altération les plus importantes de transmission de données :
    </div>
   ...
   <div>
    ...
    <input id="myField3" type="text"><br>
   
        </div>
        <div>
           <input id="btn6" type="submit" value="OK" onclick="C3();M1();">
           <button id="btn40" type="button" ><a href="res4.php"> suivant </a></button>
           <button id="btn41" type="button" ><a href="res4.php"> suivant </a></button>
        </div>
