...
<body>
 ...
 Exam</a></li>
    ...
    <div class="cour">
        <a class="text" href="file:///C:/wamp64/www/cloud/afterlogin/tdexam/exam%20reseau/res1.php">Réseau</a>
        <a class="book-bt" href="#"><i class="fa fa-book" aria-hidden="true"></i></a>
    </div>
    <div class="question">
         <br>
        Citez les trois mode de transmission qui peuvent cractériser un canal de communication :
    </div>

   <div>
        <div class="reponse">
           
    <input id="myField0" type="text"><br><br>
    <input id="myField1" type="text"><br><br>
    <input id="myField2" type="text"><br><br>
   
        </div>
        <div>
           <input id="btn6" type="submit" value="OK" onclick="C1();M1();">
           <button id="btn40" type="button" ><a href="res2.php"> suivant </a></button>
           <button id="btn41" type="button" ><a href="res3.php"> suivant </a></button>
        </div>
    </div>
