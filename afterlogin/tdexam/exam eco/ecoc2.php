...
<body>
    ...
    <div class="question">
        2/8 <br> 
        De quel type d'agents economiques s'agissent les syndicats :
    </div>
   ...
   <div>
    ...
    <input id="myField1" type="text"><br>
        ...
        <div>
           ...
           <button id="btn40" type="button" ><a href="ecoc4.php"> suivant </a></button>
           <button id="btn41" type="button" ><a href="ecoc5.php"> suivant </a></button>
