...
<body>
    ...
    <div class="question">
        8/8 <br> 
        Donner l'égalité qui lie les agrégat macroéconomiques et qui désigne l'equilibre Ressources_Emplois (on note le produit interieur brut par PIB, les Importations par M, la consomation par C, les investissements par I, les dépenses publiques par G et les exportations par X ):
    </div>
   ...
   <div>
    ...
    <input id="myField7" type="text"><br>
   
        </div>
        <div>
           <input id="btn6" type="submit" value="OK" onclick="C8();M1();">
