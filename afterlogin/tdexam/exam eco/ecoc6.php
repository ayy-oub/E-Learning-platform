...
<body>
    ...
    <div class="question">
        6/8 <br> 
        Donner la formule de calcul du solde de la balance comercial on note X  pour les Exportations et M pour les Importations :
    </div>
   ...
   <div>
    ...
    <input id="myField5" type="text"><br>
   
        </div>
        <div>
           <input id="btn6" type="submit" value="OK" onclick="C6();M1();">
           <button id="btn4" type="button"><a href="ecoc8.php"> suivant</a></button>
