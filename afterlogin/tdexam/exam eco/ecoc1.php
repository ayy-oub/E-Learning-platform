...
<body>
    ...
    <div class="question">
        1/8 <br>
        De quel type d'agents économiques s'agissent les administrations de sécurité sociales (CNSS et mutuelles) :
    </div>
   ...
   <div>
    ...
    <input id="myField0" type="text"><br>
        ...
        <div>
           ...
           <button id="btn40" type="button" ><a href="ecoc2.php"> suivant </a></button>
           <button id="btn41" type="button" ><a href="ecoc3.php"> suivant </a></button>
