...
<body>
    ...
    <div class="question">
        4/8 <br> 
        L'un des cas spécifiques de la loi de l'offre et la demande c'est quand l demande sur un bien augmente avec l'augmentation de son prix dans a mesure où il devient un signe socialement distinctif.Quelle est le nom de cet effet ? :
    </div>
