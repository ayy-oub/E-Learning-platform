...
<body>
    ...
    <div class="question">
        7/8 <br> 
        Donner la formule de calcul du taux de couverture commerciale on note X  pour les Exportations et M pour les Importations  :
    </div>
   ...
   <div>
    ...
    <input id="myField6" type="text"><br>
   
        </div>
        <div>
           <input id="btn6" type="submit" value="OK" onclick="C7();M1();">
           <button id="btn4" type="button"><a href="eco8.php"> suivant</a></button>
