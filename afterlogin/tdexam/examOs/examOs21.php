 ...
 Exam</a></li>
    ...
    <div class="container">
      ...
      <div class="question" style="font-size: 15px;">
        <h2>Exercice 2:</h2>
        <h4>Écrivez un programme C qui affiche "bonjour", crée deux processus P1 et P2 et dit "au
        revoir". P1 doit attendre deux secondes puis afficher les 10 premiers entiers avant de se
        terminer. P2 doit attendre la fin de P1 puis lister le contenu du répertoire courant.</h4>
      </div>

      <div>
        <div class="choice">
          <button id="btnC" type="button" style="height: 100px; width: 300px;"><a href="https://www.onlinegdb.com/online_c_compiler">Résoudre l'exercice</a></button>
        </div>
        <div>
          <button id="btn40" type="button" style="display: block;"><a href="http://cloud/afterlogin/cr1.php"> quiter </a></button>
          <button id="btn5" type="button"><a href="ExamOs1.html">retour</a></button>
        </div>
      </div>
