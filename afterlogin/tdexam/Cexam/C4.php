...
<body>
 ...
 Exam</a></li>
    ...
    <div class="question">
        4/5 <br>
       Ecrire un programme C qui lit deux réels R1 et R2 qui représentent les rayons de deux cercles concentriques, et renvoie ensuite l'aire de la surface comprise entre les deux cercles (surface grise).<br>
...
int main()
{<br>
    double R1,R2,aire1,aire2,aire;<br>
    printf("Donnez les rayons des deux cercles:\n");<br>
    scanf("%lf%lf",&R1,&R2);<br>
    aire1 = <input id="myField0" type="text">;<br>
    aire2 = 3.14*R2*R2;<br>
    aire = fabs(aire1-aire2);<br>
    printf("L'aire de la surface entre les deux cercles est: %.4lf\n",aire);<br>
    return 0;<br>
}<br>
        </div>
        <div>
           <input id="btn6" type="submit" value="OK" onclick="MT1();C4();">
           <button id="btn40" type="button" ><a href="C6.php"> suivant </a></button>
           <button id="btn41" type="button" ><a href="C7.php"> suivant </a></button>
           <a id="btn7" href="https://rextester.com/OYSVV7950" target="_blank">Try it Urself </a>
        </div>
    </div>
