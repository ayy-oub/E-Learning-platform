...
<body>
 ...
 Exam</a></li>
    ...
    <div class="question">
         <br>
        Si E et F sont des espaces vectoriels alors dim(E+F) = dimE + dimF -dim(E &#8746 F):
    </div>
    <button id="btn04" type="button" onclick="MT2();rep();">Vrai</button>
    <button id="btn24" type="button" onclick="MT2();rep1();">Faux</button>
