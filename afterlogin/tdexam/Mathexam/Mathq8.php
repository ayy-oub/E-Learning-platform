...
<body>
 ...
 Exam</a></li>
    ...
    <button id="btn08" type="button" onclick="document.getElementById('btn4').style.display='block';rep();">{ X / A*X &#x2260 0}</button>
    <button id="btn18" type="button" onclick="document.getElementById('btn4').style.display='block';rep1();">{ X / A*X = 0}</button>
    <button id="btn28" type="button" onclick="document.getElementById('btn4').style.display='block';rep();">{ X / X*A &#x2260 0}</button>
    <button id="btn38" type="button" onclick="document.getElementById('btn4').style.display='block';rep();">{ X / X*A = 0}</button> 
    <button id="btn4" type="button" ><a href="http://cloud/afterlogin/tdexam/Mathexam/Mathq11.php"> suivant</a></button>
