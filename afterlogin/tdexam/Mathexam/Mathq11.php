...
<body>
 ...
 Exam</a></li>
    ...
    <div class="question">
        <br>
F et G sont dits supplémentaires dans E si et seulement si les deux conditions suivantes sont satisfaites :<br>
(1) E = F + G.        <br>
(2) F &#x2229 F = {0}.          <br>

  </div>
    <button id="btn011" type="button" onclick="rep1f()">Vrai</button>
    <button id="btn211" type="button" onclick="repf()">Faux</button>
