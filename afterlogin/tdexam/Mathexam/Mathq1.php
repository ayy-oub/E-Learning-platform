...
<body>
 ...
 Exam</a></li>
   ...
   <div>
        ...
        <div>
           <input  id="sub" type ="submit" onclick="validateform1()" value="Ok">
           <button id="btn40" type="button" ><a href="http://cloud/afterlogin/tdexam/Mathexam/Mathq2.php"> suivant </a></button>
           <button id="btn41" type="button" ><a href="http://cloud/afterlogin/tdexam/Mathexam/Mathq3.php"> suivant </a></button>
           <button id="btn42" type="button" ><a href="http://cloud/afterlogin/tdexam/Mathexam/Mathq4.php"> suivant </a></button>
        </div>
    </div>
