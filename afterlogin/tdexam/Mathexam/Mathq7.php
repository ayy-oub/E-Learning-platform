...
<body>
 ...
 Exam</a></li>
    ...
    <div class="question">
        <br>
        Une matrice A appartient à M<sub>nxn</sub>(C) est à diagonale strictement dominante lorsque |a<sub>ij</sub>| < &#x3A3<sub>j &#8800 i</sub> |a<sub>ij</sub>| ?
    </div>
    <button id="btn07" type="button" onclick="MT2();rep();">Vrai</button>
    <button id="btn27" type="button" onclick="MT2();rep1();">Faux</button>
