 ...
 Exam</a></li>
    ...
    <div class="container">
      ...
      <div class="question" style="font-size: 15px;">
        <h2>Exercice 3:</h2>
        <h4>Une source d’information génère des zéros et des uns avec les probabilités p(0) = 0.8 et p(1) = 0.2.
        Les séquences de symboles sont codées avec les symboles code {a, b, c, d, e} selon la table :</h4>
        <table>
          <tr>
            <td>Message</td>
            <td>1</td>
        ...
        <ol>
          <li>Ce code est-il uniquement et instantanément décodable ?</li>
          <li>Déterminer la quantité d’information moyenne pour un symbole du code. Quelle est l’efficacité de ce code ?</li>
        </ol>
      </div>
      <div>
        <div class="choice">
          <h4>Réponse :</h4>
          <input type="button" onclick="rep1();MT1();" name="q3" value="1-Oui 2- " id="c1"><br>
          <input type="button" onclick="rep();MT1();" name="q3" value="1-Non 2-" id="c2"> <br>
          <input type="button" onclick="rep1();MT1();" name="q3" value="1-Oui 2-" id="c3"> <br>
        </div>
        <div>
          <button id="btn40" type="button" ><a href="examCodage33"> suivant </a></button>
           <button id="btn5" type="button"><a href="examCodage22.php">retour</a></button>
        </div>
      </div>
