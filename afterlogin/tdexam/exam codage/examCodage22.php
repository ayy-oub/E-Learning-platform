...
<body>
 ...
 Exam</a></li>
    ...
    <div class="container">
      ...
      <div class="question">
        <h2>Exercice 2:</h2>
        <h4>Applique la procédure de décodage pas à pas à la séquence 10110000101010100 avec le code sans préfixe suivant :</h4>
        <table>
          <tr>
            <td>Si</td>
            <td>a</td>
      ...
      <div>
        <div class="choice">
          ...
          <input type="button" onclick="rep1();MT2();" name="q22" value="hdief" id="c1"><br>
          <input type="button" onclick="rep();MT2();" name="q22" value="dhief" id="c2"><br>
          <input type="button" onclick="rep1();MT2();" name="q22" value="hiefd" id="c3"><br>
        </div>
        <div>
           <button id="btn40" type="button" ><a href="examCodage31.php"> suivant </a></button>
           <button id="btn41" type="button" ><a href="examCodage32.php"> suivant </a></button>
           <button id="btn42" type="button" ><a href="examCodage33.php"> suivant </a></button>
           <button id="btn5" type="button"><a href="examCodage1.php">retour</a></button>
        </div>
      </div>
