 ...
 Exam</a></li>
    ...
    <div class="container">
      ...
      <div class="question" style="font-size: 15px;">
        <h2>Exercice 3:</h2>
        <h4>Code sans préfixe optimal. Méthode de Huffman.</h4>
          soit une source d'alphabet &#8486 et de distribution de probabilité suivante :
          <table>
          <tr>
            <td>Si</td>
            <td>a</td>
        ...
        <ol>
          <li>Quelle est la longueur moyenne minimal pour un code binaire de cette source ?</li>
          <li>Existe-t-il un code absolument optimal ?</li>
          <li>Construire un code sans préfixe optimal selon la méthode de Huffman.</li>
          <li>Représenter ce code sous la forme d'arbre.</li>
        </ol>
      </div>
      ...
      <div>
        <div class="choice">
          ...
          <input type="button" name="q3" onclick="rep1();MT1();" value="1- 4.13 bits/symbole 2- Non" id="c1"><br>
          <input type="button" name="q3" onclick="rep1();MT1(); " value="1- 3.14 bits/symbole 2- Non " id="c2"><br>
          <input type="button" name="q3" onclick="rep();MT1(); " value="1- 3.14 bits/symbole 2- Oui" id="c3"><br>
        </div>
        <div>
          <button id="btn40" type="button" ><a href="examCodage32"> suivant </a></button>
           <button id="btn5" type="button"><a href="examCodage21.php">retour</a></button>
        </div>
      </div>
