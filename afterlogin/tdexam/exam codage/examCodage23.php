...
<body>
 ...
 Exam</a></li>
    ...
    <div class="container">
      ...
      <div class="question">
        <h2>Exercice 2:</h2>
        <h4>Construire l'arbre associé au code suivant :</h4>
        <table>
          <tr>
            <td>Si</td>
            <td>a</td>
      ...
      <div>
        <div class="choice">
          <h4>Réponse :</h4>
          <input type="button" name="q3" onclick="rep();MT2();" value="bien fait" id="c1"><br>
          <input type="button" name="q3" onclick="rep1();MT2();" value="Non" id="c2"><br>
        </div>
        <div>
