...
while ($row = mysqli_fetch_array($result)) { ?>
 <strong><?php echo $row["username"]; ?>   <i class="fa fa-commenting" aria-hidden="true"></i></strong><br> 
<?php } ?>
  </p>
    <a class="user-btn" href="#"><i class="fa fa-users" aria-hidden="true"></i></a>
  </div>
  <style type="text/css">
    /*------searchbox-------*/
.user-box {
